...
public class Datapackage {
    ...
    public Datapackage(int id, int deviceId, String time_Package, double PH, double salt, double oxy, double temp, double h2S, double NH3, double NH4Min, double NH4Max, double NO2Min, double NO2Max, double sulfideMin, double sulfideMax, String ngayTao) {
        Id = id;
        DeviceId = deviceId;
        Time_Package = time_Package;
        this.PH = PH;
